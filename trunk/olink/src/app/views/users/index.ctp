...
<td>
	<table cellspacing="1" cellpadding="1" class="tableList" id="tableList">
	  <tr >
  	  ...
  	  <?php $i=0; foreach ($administrators as $administrator):?>
	  	<tr >
		    <td><input type="checkbox" name ="functionMenuId[]" value="<?php echo $i;?>"  />&nbsp;<?php echo ($i+1); $i++; ?></td>
		    <td ><?php echo $administrator[0];?></td>
			<td><?php echo $administrator[2];?></td>
		    <td ><?php echo $administrator[1];?></td>
		</tr>
	  <?php endforeach; ?>
	 </table>
</td>
