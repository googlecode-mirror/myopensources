...
class Image_Lib {
	...
	var $image_library		= 'gd2';  	// Can be:  gd, gd2, magickwand, imagemagick, netpbm
	var $library_path		= '';
	...
	function rotate()
	{
		...
		if (in_array($this->image_library, array('imagemagick', 'netpbm', 'magickwand') ))
		{
			$protocol = 'image_process_'.$this->image_library;
...
//		}
		...
		//  Rotate it!
		if ( !function_exists('imagerotate') ) {
			$dst_img = $this->imageRotate($src_img, $this->rotation_angle, $white);
		}
		else
