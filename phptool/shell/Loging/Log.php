...
class Loging_Log
{
                      ...
                      $level = PEAR_LOG_DEBUG)
    {
        ...
        $class = 'Log_' . $handler;
        $classfile = 'Loging/Log/' . $handler . '.php';
         ...
         */
        if (!Loging_Log::_classExists($class)) {
     ...
     *
     * <b>You MUST call this method with the $var = &Loging_Log::singleton() syntax.
                        ...
                        $level = PEAR_LOG_DEBUG)
    {
        ...
        if (!isset($instances[$signature])) {
            $instances[$signature] = &Loging_Log::factory($handler, $name, $ident,
                                                   $conf, $level);
        }
     ...
     * @since   Log 1.7.0
     *
     * @deprecated deprecated since Log 1.9.4; use Loging_Log::MAX() instead
     */
    function UPTO($priority)
    {
        return Loging_Log::MAX($priority);
    }
    ...
    {
        return (Loging_Log::MASK($priority) & $this->_mask);
    }
