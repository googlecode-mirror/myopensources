...
$tinybrowser['docroot'] = dirname(dirname(dirname(dirname(dirname(__FILE__) ) ) ) ).DIRECTORY_SEPARATOR. "img".DIRECTORY_SEPARATOR."uploads";//rtrim($_SERVER['DOCUMENT_ROOT'],'/');
...
$web_image_root = dirname(dirname(dirname(dirname(dirname( getenv("REQUEST_URI") ) ) ) ) ). "/img/uploads";
$tinybrowser['link']['image'] = $web_image_root . $tinybrowser['path']['image']; // Image links
