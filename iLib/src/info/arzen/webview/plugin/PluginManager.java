...
public class PluginManager {
	...
	public Plugin addPlugin(String className) {
	    try {
	    	className = formatPluginFullName(className);
	...
	private String formatPluginFullName(String className) {
		return String.format("info.arzen.webview.plugin.%s", className);
	}
